...
#define ROOM_LIST_TITLE_ENTER_USERNAME "Enter Username:"
#define ROOM_LIST_TITLE_ROOM_LIST "Room List:"
#define ROOM_LIST_TITLE_CREATE_ROOM "Create Room:"
...
#define ROOM_LIST_INDEX_ENTER_USERNAME -1
#define ROOM_LIST_INDEX_CREATE_ROOM -2
